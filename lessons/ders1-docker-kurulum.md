...
> **⚠️ ÖNEMLİ:** Bu ders için katılımcıların **WSL2, Docker Desktop ve workshop projesinin** bilgisayarlarında kurulu olması GEREKİR. Kurulum adımları için **[docs/kurulum-oncesi.md](../docs/kurulum-oncesi.md)** dosyasına bakın. Bu döküman workshop'tan **en az 1 gün önce** katılımcılara gönderilmelidir.

### Kurulum Kontrolü (Ders başlamadan önce)
...
Tüm katılımcıların kurulumlarının tam olduğundan emin olun:

```powershell
# 1. WSL2 kontrol
wsl --status
# Beklenen: Default Version: 2

# 2. Docker Desktop kontrol
docker --version
# Beklenen: Docker version 24.0.x+

docker compose version
# Beklenen: Docker Compose version v2.x.x+

# 3. Proje klasörü kontrol
cd web-gis-vibe-workshop
ls docker-compose.yml
# Dosya görünmeli
```

**Kurulum Sorunları İçin:**
- Kurulum dosyası eksik olanlar için: [docs/kurulum-oncesi.md](../docs/kurulum-oncesi.md)'den adım adım talimatları gösterin
- Küçük sorunlar: Ders başlamadan 10-15 dakika önce yardım edin
- Büyük sorunlar: Yedek bilgisayar sağlayın veya katılımcıyı ikili çalışmaya yönlendirin
